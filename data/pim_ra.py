# From https://github.com/rwightman/pytorch-image-models/blob/master/timm/data/auto_augment.py
...
class AugmentOp:
    ...
    def __init__(self, name, prob=0.5, magnitude=10, mode=None, hparams=None):
    ...
    def __init__(self, ops, num_layers=2, choice_weights=None, particles=None, weights=None, seed=None):
        ...
        if self.particles is not None:
            if self.particles.ndim == 1:
                assert self.particles.shape[0] == len(self.ops)
            else:
